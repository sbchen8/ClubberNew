...
<html>
    <head>
        ...
        <script src="Script/AuctionManagement.js"  type="text/javascript" charset="windows-1255" ></script>
    ...
    <div class= "page-description">בדף זה ניתן לצפות בכל ההצעות שהתקבלו </div>
